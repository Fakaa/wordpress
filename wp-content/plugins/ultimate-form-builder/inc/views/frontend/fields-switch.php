...
if ( $field_type != 'hidden' ) {
    ...
    ?>
    <div data-field-id="<?php echo $key; ?>" class="ufb-form-field-wrap <?php echo 'ufb-' . $field_type . '-wrap'; ?> <?php echo $column_class; ?> <?php echo ($val[ 'field_class' ] != '') ? esc_attr($val[ 'field_class' ]) : ''; ?>" <?php echo ($val[ 'field_id' ] != '') ? 'id="' . esc_attr($val[ 'field_id' ]) . '"' : ''; ?> <?php echo $hidden; ?>>
