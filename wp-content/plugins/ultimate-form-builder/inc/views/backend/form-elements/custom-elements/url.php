<div class="ufb-url-reference">
    <div class="ufb-each-form-field ufb-relative">
        ...
        <div class="ufb-form-field-wrap">
            <label class="ufb-field-label-ref"><?php echo ($val[ 'field_label' ] != '') ? esc_attr( $val[ 'field_label' ] ) : __( 'Untitled URL', UFB_TD ); ?></label>
        ...
        <div class="ufb-field-settings-wrap" style="display:none;">
            ...
            <div class="ufb-form-field-wrap">
                ...
                <div class="ufb-form-field">
                    <input type="text" name="field_data[<?php echo $key; ?>][placeholder]" placeholder='<?php _e( 'Your website URL here', UFB_TD ); ?>' value="<?php echo esc_attr( $val[ 'placeholder' ] ); ?>"/>
                </div>
            </div>
            <div class="ufb-form-field-wrap">
            ...
            <input type="hidden" name="field_data[<?php echo $key; ?>][field_type]" value="url" data-field-name="<?php echo $key; ?>" data-field-type="field_type"/>
        </div>
