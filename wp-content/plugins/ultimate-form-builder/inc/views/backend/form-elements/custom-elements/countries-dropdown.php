<div class="ufb-country-dropdown-reference">
    <div class="ufb-each-form-field ufb-relative">
        ...
        <div class="ufb-form-field-wrap">
            <label class="ufb-field-label-ref"><?php echo ($val[ 'field_label' ] != '') ? esc_attr( $val[ 'field_label' ] ) : __( 'Untitled Country', UFB_TD ); ?></label>
        ...
        <div class="ufb-field-settings-wrap" style="display:none;">
            ...
            <div class="ufb-form-field-wrap">
                ...
                <div class="ufb-form-field">
                    <input type="text" name="field_data[<?php echo $key; ?>][field_label]" placeholder="<?php _e( 'Your Website', UFB_TD ); ?>" class="ufb-field-label-field ufb-field" value="<?php echo esc_attr( $val[ 'field_label' ] ); ?>"/>
                </div>
            </div>
            <div class="ufb-form-field-wrap">
                <label>
            ...
            <div class="ufb-form-field-wrap">
                ...
                <div class="ufb-form-field">
                    <input type="text" name="field_data[<?php echo $key; ?>][first_option_label]" placeholder="<?php _e( 'Choose Country', UFB_TD ); ?>" value="<?php echo isset( $val[ 'first_option_label' ] ) ? esc_attr( $val[ 'first_option_label' ] ) : ''; ?>"/>
                </div>
            </div>
            <div class="ufb-form-field-wrap">
                <label><?php _e( 'Pre Selected Country', UFB_TD ); ?></label>
                <div class="ufb-form-field">
                    <select name="field_data[<?php echo $key; ?>][pre_selected_country]">
                        <option value=""><?php _e('Choose Country',UFB_TD);?></option>
                        <?php foreach($country_list as $country){
                            ?>
                            <option value="<?php echo $country['id'] ?>" <?php selected( $val[ 'pre_selected_country' ],$country['id']);?>><?php echo $country['name']; ?></option>
                            <?php 
                        }?>
                    </select>       
                </div>
            ...
            <input type="hidden" name="field_data[<?php echo $key; ?>][field_type]" value="country-dropdown" data-field-name="<?php echo $key; ?>" data-field-type="field_type"/>
        </div>
