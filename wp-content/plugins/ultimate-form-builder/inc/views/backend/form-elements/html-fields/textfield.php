<div class="ufb-each-form-field ufb-relative">
    ...
    <div class="ufb-form-field-wrap">
        <label class="ufb-field-label-ref"><?php echo (isset( $val[ 'field_label' ] ) && $val[ 'field_label' ] != '') ? esc_attr( $val[ 'field_label' ] ) : __( 'Untitled Texfield', UFB_TD ); ?></label>
    ...
    <div class="ufb-field-settings-wrap" style="display:none;">
        ...
        <div class="ufb-form-field-wrap">
            ...
            <div class="ufb-form-field">
                <input type="text" name="field_data[<?php echo $key; ?>][field_label]" placeholder="<?php _e( 'Your Name', UFB_TD ); ?>" class="ufb-field-label-field ufb-field" data-field-name="<?php echo $key; ?>" data-field-type="field_label" value="<?php echo (isset( $val[ 'field_label' ] ) && $val[ 'field_label' ] != '') ? esc_attr( $val[ 'field_label' ] ) : ''; ?>"/>
            </div>
        </div>
        <div class="ufb-form-field-wrap">
            <label>
        ...
        <div class="ufb-form-field-wrap">
            ...
            <div class="ufb-form-field">
                <input type="text" name="field_data[<?php echo $key; ?>][error_message]" placeholder="<?php _e( 'Please fill your name', UFB_TD ); ?>" value="<?php echo (isset( $val[ 'error_message' ] )) ? esc_attr( $val[ 'error_message' ] ) : ''; ?>"/>
            </div>
        </div>
        <div class="ufb-form-field-wrap">
            <label><?php _e( 'Placeholder', UFB_TD ); ?></label>
            <div class="ufb-form-field">
                <input type="text" name="field_data[<?php echo $key; ?>][placeholder]" placeholder='<?php _e( 'Your Name here', UFB_TD ); ?>'  value="<?php echo (isset( $val[ 'placeholder' ] )) ? esc_attr( $val[ 'placeholder' ] ) : ''; ?>"/>
            </div>
        </div>
        <div class="ufb-form-field-wrap">
            <label><?php _e( 'Pre filled value', UFB_TD ); ?></label>
            <div class="ufb-form-field">
                <input type="text" name="field_data[<?php echo $key; ?>][pre_filled_value]"   value="<?php echo (isset( $val[ 'pre_filled_value' ] )) ? esc_attr( $val[ 'pre_filled_value' ] ) : ''; ?>"/>
            </div>
        </div>
        <div class="ufb-form-field-wrap">
            <label><?php _e( 'ID of the field', UFB_TD ); ?></label>
            <div class="ufb-form-field">
                <input type="text" name="field_data[<?php echo $key; ?>][field_id]" value="<?php echo (isset( $val[ 'field_id' ] )) ? esc_attr( $val[ 'field_id' ] ) : ''; ?>"/>
            </div>
        </div>
        <div class="ufb-form-field-wrap">
