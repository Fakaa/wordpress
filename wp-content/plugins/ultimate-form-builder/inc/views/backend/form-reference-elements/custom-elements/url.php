<div class="ufb-url-reference">
    <div class="ufb-each-form-field ufb-relative">
        ...
        <div class="ufb-form-field-wrap">
            <label class="ufb-field-label-ref"><?php _e( 'Untitled URL Field', UFB_TD ); ?></label>
        ...
        <div class="ufb-field-settings-wrap" style="display:none;">
            ...
            <div class="ufb-form-field-wrap">
                ...
                <div class="ufb-form-field">
                    <input type="text" name="field_data[ufb_key][field_label]" placeholder="<?php _e( 'Your Website', UFB_TD ); ?>" class="ufb-field-label-field ufb-field" data-field-name="ufb_key" data-field-type="field_label"/>
                </div>
            </div>
            <div class="ufb-form-field-wrap">
            ...
            <div class="ufb-form-field-wrap">
                ...
                <div class="ufb-form-field">
                    <input type="text" name="field_data[ufb_key][error_message]" placeholder="<?php _e( 'Please fill your URL', UFB_TD ); ?>" data-field-name="ufb_key" data-field-type="error_message"/>
                </div>
            </div>
            <div class="ufb-form-field-wrap">
                <label><?php _e( 'Placeholder', UFB_TD ); ?></label>
                <div class="ufb-form-field">
                    <input type="text" name="field_data[ufb_key][placeholder]" placeholder='<?php _e( 'Your website URL here', UFB_TD ); ?>' data-field-name="ufb_key" data-field-type="placeholder"/>
                </div>
            </div>
            <div class="ufb-form-field-wrap">
            ...
            <input type="hidden" name="field_data[ufb_key][field_type]" value="url" data-field-name="ufb_key" data-field-type="field_type"/>
        </div>
