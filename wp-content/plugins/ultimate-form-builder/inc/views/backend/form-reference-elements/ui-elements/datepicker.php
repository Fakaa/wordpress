<div class="ufb-datepicker-reference">
    <div class="ufb-each-form-field ufb-relative">
        ...
        <div class="ufb-form-field-wrap">
            <label class="ufb-field-label-ref"><?php _e( 'Untitled Datepicker', UFB_TD ); ?></label>
            <div class="ufb-form-field">
                <img src="<?php echo UFB_IMG_DIR . '/datepicker-preview.jpg'; ?>"/>
            </div>
        ...
        <div class="ufb-field-settings-wrap" style="display:none;">
            ...
            <div class="ufb-form-field-wrap">
                ...
                <div class="ufb-form-field">
                    <input type="text" name="field_data[ufb_key][field_label]" placeholder="<?php _e( 'Booking Date', UFB_TD ); ?>" class="ufb-field-label-field ufb-field" data-field-name="ufb_key" data-field-type="field_label"/>
                </div>
            </div>
            <div class="ufb-form-field-wrap">
            ...
            <div class="ufb-form-field-wrap">
                ...
                <div class="ufb-form-field">
                    <input type="text" name="field_data[ufb_key][error_message]" placeholder="<?php _e( 'Please fill your name', UFB_TD ); ?>" data-field-name="ufb_key" data-field-type="error_message"/>
                </div>
            </div>
            <div class="ufb-form-field-wrap">
                <label><?php _e( 'Placeholder', UFB_TD ); ?></label>
                <div class="ufb-form-field">
                    <input type="text" name="field_data[ufb_key][placeholder]" placeholder='<?php _e( 'Enter your booking date.', UFB_TD ); ?>' data-field-name="ufb_key" data-field-type="placeholder"/>
                </div>
            </div>
            <div class="ufb-form-field-wrap">
                <label><?php _e( 'Date Format Type', UFB_TD ); ?></label>
                <div class="ufb-form-field">
                    <label><input type="radio" name="field_data[ufb_key][date_format_type]" value="pre_available" checked="checked" class="ufb-date-format"/><span class="ufb-radio-label"><?php _e( 'Pre Available Format', UFB_TD ); ?></span></label>
                    <label><input type="radio" name="field_data[ufb_key][date_format_type]" value="custom"  class="ufb-date-format"/><span class="ufb-radio-label"><?php _e( 'Custom Format', UFB_TD ); ?></span></label>
                </div>
            </div>
            <div class="ufb-form-field-wrap ufb-date-ref ufb-available-format">
            ...
            <input type="hidden" name="field_data[ufb_key][field_type]" value="datepicker" data-field-name="ufb_key" data-field-type="field_type"/>
        </div>
