...
<?php else: ?>
	...
	<fieldset id="ci-panel-logo" class="set">
		...
		<p class="guide"><?php _e('Upload an alternative version of your logo here. This will appear in the footer and it should be smaller and greyscale #BFBFBF color. (Optional).', 'ci_theme'); ?></p>
		<?php ci_panel_upload_image('footer_logo', __('Upload your footer logo', 'ci_theme')); ?>
	</fieldset>
