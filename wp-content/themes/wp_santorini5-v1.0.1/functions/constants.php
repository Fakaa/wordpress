...
if(!defined('CI_THEME_NAME')) 		define('CI_THEME_NAME', 'santorini');
...
if(!defined('CI_THEME_NICENAME')) 	define('CI_THEME_NICENAME', 'Santorini Resort');
...
if(!defined('CI_DOCS'))				define('CI_DOCS', 'http://www.cssigniter.com/support/viewtopic.php?f=69&t=6488');
...
if(!defined('CI_FORUM'))			define('CI_FORUM', 'http://www.cssigniter.com/support/viewforum.php?f=69');
