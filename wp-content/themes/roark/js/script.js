(function($) {
    ...
    $.fn.imageCover = function(opts) {
        return this.each(function() {
            ...
            image.wrap('<div class="wil-imageCover"></div>');
            $('.wil-imageCover', self).css({
                'display': 'block',
    ...
    function checkDevices() {
        var classDevice = isMobile.any() ? 'small-devices' : 'large-devices',
            classIe = isIE ? 'ie' : '';
        $('body').addClass(classDevice + ' ' + classIe);
    }
