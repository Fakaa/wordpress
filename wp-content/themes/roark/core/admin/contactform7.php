...
if(!class_exists('roark_contactform7')) {
    class roark_contactform7
    {
        public function __construct()
        {
            ...
            add_action( 'wp_ajax_roark_contactform7_demo', array($this, 'roark_contactform7_demo' ));
            add_action( 'wp_ajax_nopriv_roark_contactform7_demo', array($this, 'roark_contactform7_demo' ));
        }
        ...
        public function wiloke_contactfom7_helper()
        {
            ...
            <div id="wilokecontactform7" class="contactform7">
                <div class="postbox-container">
                    <div class="postbox">
                        <h2 class="hndle"><?php esc_html_e('Contact form 7 Option', 'roark'); ?></h2>
                        <div class="inside">
                            <p><?php esc_html_e('Click Import button make this contact form look like demo.', 'roark'); ?></p>
                            <button id="wiloke-import-contactform7" class="button button-primary"><?php esc_html__('Import', 'roark'); ?><?php esc_html_e('Import', 'roark'); ?></button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        public function roark_contactform7_demo() { 
            ob_start(); ?>
