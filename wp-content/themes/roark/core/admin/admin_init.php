...
add_action( 'admin_enqueue_scripts', 'roark_enqueue_admin' );

if( !function_exists('roark_enqueue_admin') ) {
	function roark_enqueue_admin() {
	    ...
	    if( !wp_style_is('font-linea' , 'enqueued') ) {
	    	wp_register_style('font-linea', ROARK_CSS_URI .'lib/font-linea.css', array(), '', 'all');
