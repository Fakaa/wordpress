<?php
	...
	// Mobile layout class
	$header_class .= apply_filters( 'nm_header_centered_mobile_class', 'alt-mobile-layout' );
?>
	
    <!-- header -->
    <header id="nm-header" class="nm-header centered clear <?php echo esc_attr( $header_class ); ?>" role="banner">
