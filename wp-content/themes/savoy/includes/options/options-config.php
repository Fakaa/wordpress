	...
	Redux::setSection( $opt_name, array(
		...
		'fields'	=> array(
			...
			array(
				...
				'options'	=> array( '0' => 'Disable', 'alt-logo-home' => 'Display in Home-page header', 'alt-logo-fixed' => 'Display in Floating header', 'alt-logo-home alt-logo-fixed' => 'Display in Home-page and Floating header' ),
				'default'	=> '0'
			),
            array(
				'id'	=> 'alt_logo',
			...
			array(
				'id'		=> 'menu_login_popup',
				'type'		=> 'switch', 
				'title'		=> __( 'Login Menu - Popup', 'nm-framework-admin' ),
	...
	Redux::setSection( $opt_name, array(
		...
		'fields'	=> array(
			...
			array(
				...
				'options'	=> array( 'header' => 'Display in Header', 'default' => 'Display in Sidebar', 'disabled' => 'Disable' ),
				'default'	=> 'disabled'
			),
			array(
	...
	Redux::setSection( $opt_name, array(
		...
		'fields'	=> array(
            array(
				...
				'options'	=> array( '0' => 'Display on all shop pages', '1' => 'Display on main shop page only' ),
				'default'	=> '0'
			),
			array (
			...
			array(
				'id'		=> 'cart_show_item_subtotal',
				'type'		=> 'switch',
				'title'		=> __( 'Item Subtotal', 'nm-framework-admin' ),
				'desc'		=> __( 'Display subtotal for each item in the cart.', 'nm-framework-admin' ),
				'default'	=> 0,
				'on'		=> 'Enable',
				'off'		=> 'Disable'
			)
	...
	Redux::setSection( $opt_name, array(
		...
		'fields'	=> array(
            ...
            array(
				...
				'type'		=> 'switch',
				'title'		=> __( 'Custom Select Boxes', 'nm-framework-admin' ),
				'desc'		=> __( 'Use custom select boxes for variable products.', 'nm-framework-admin' ),
				'default'	=> 1,
				'on'		=> 'Enable',
				'off'		=> 'Disable'
			),
            array(
				...
				'type'		=> 'select',
				'title'		=> __( 'Grouped Products - Quantity Arrows', 'nm-framework-admin' ),
				'desc'		=> __( 'Select grouped products quantity arrows layout.', 'nm-framework-admin' ),
            ...
            array (
				'id' 	=> 'product_related_info',
				'icon'	=> true,
				'type'	=> 'info',
				'raw'	=> '<h3 style="margin: 0;">' . __( 'Related Products', 'nm-framework-admin' ) . '</h3>',
			),
            array(
				'id'			=> 'product_related_columns',
				'type'			=> 'slider',
				'title'			=> __( 'Columns', 'nm-framework-admin' ),
				'desc'			=> __( 'Select the number of related product columns to display.', 'nm-framework-admin' ),
				'default'		=> 4,
				'min'			=> 1,
				'max'			=> 6,
				'step'			=> 1,
            ...
            array(
				...
				'type'			=> 'slider',
				'title'			=> __( 'Products per Page', 'nm-framework-admin' ),
				'desc'			=> __( 'Select the number of related products to display.', 'nm-framework-admin' ),
				'default'		=> 4,
				'min'			=> 1,
				'max'			=> 48,
				'step'			=> 1,
        ...
        Redux::setSection( $opt_name, array(
            ...
            'fields'	=> array(
                array(
                    ...
                    'type'	=> 'select',
                    'title'	=> __( 'Portfolio Page', 'nm-framework-admin' ),
                    'desc'	=> __( 'Select portfolio home-page (used for the "Show All" link on single portfolio pages).', 'nm-framework-admin' ),
                    'data'	=> 'pages'
                )
            )
        ) );
