            ...
            <div class="nm-row">
                ...
                <div class="col-xs-3">
                    <div class="nm-single-product-menu">
						<?php
							/* Product navigation */
							next_post_link( '%link', apply_filters( 'nm_single_product_menu_next_icon', '<i class="nm-font nm-font-play flip"></i>' ), $navigate_same_term, array(), 'product_cat' );
							previous_post_link( '%link', apply_filters( 'nm_single_product_menu_prev_icon', '<i class="nm-font nm-font-play"></i>' ), $navigate_same_term, array(), 'product_cat' );
						?>
                    </div>
                </div>
            </div>
