...
if ( isset( $_GET['shop_page'] ) && $_GET['shop_page'] === '0' ) {
	...
	// Display shop-page content outside the main shop archive/listing page?
	$show_shop_page = ( $nm_theme_options['shop_content_home'] && ! is_shop() ) ? false : true;
}
...
if ( $nm_theme_options['shop_filters'] == 'default' ) {
	...
	$show_sidebar_filters = true;
    $sidebar_class = 'nm-shop-sidebar-' . $nm_theme_options['shop_filters'] . ' nm-shop-sidebar-position-' . $nm_theme_options['shop_filters_sidebar_position'];
	$shop_column_size = 'col-md-9 col-sm-12';
} else {
	$show_sidebar_filters = false;
    $sidebar_class = 'nm-shop-sidebar-' . $nm_theme_options['shop_filters'];
...
get_header(); ?>
    ...
    <div id="nm-shop" class="nm-shop <?php echo esc_attr( $sidebar_class ); ?>">
        <?php
            /**
